...
<footer>
    ...
    <script type="text/javascript" src="<?=ASSETS?>kebab_template/js/responsee.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>kebab_template/js/jquery.events.touch.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>kebab_template/owl-carousel/owl.carousel.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>kebab_template/js/template-scripts.js"></script> 
  </body>
</html>